...
def generate(meter_name_list, main_meter, save_path, engine):
    ...
    for meter_name in meter_name_list:
        ...
        for appliance_id in appliance_id_list:
            ...
            app_df = generate_appliance(appliance_name, appliance_id, meter_name, sample_seconds, debug, engine)
...
# 生成单一电器数据
def generate_appliance(appliance_name, appliance_id, meter, sample_seconds, debug, engine):
